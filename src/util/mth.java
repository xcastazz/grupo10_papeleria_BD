...
public class mth {
  ...
  private boolean debug = false; //activar true para probar la clase de matematicas (metodos glamp por ahora)
...
////////////////////////////////////////////////////////////////////////////////////////
/// Metodos Glamp (para int y double)
  public int glamp(int val1, int val2) {
    int res = val1 - val2;
    if (res < 0) {
      System.out.print("Insuficiente, Faltan: "+ res*(-1)+"");
      return -1;
    }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    // Solo para debug ojo, metodos privados para prueba. cuando debug es true
    // se va a probar si sirve glamp con valores aleatorios
  ...
  private void debugPrint() {
    ...
    do {
      ...
      if (res != -1 && res >= 0) {
        ...
        System.out.println(" Probando otra vez glamp ");
      }
    func.luafunc.wait(2.0);
    } while (debug < 120);
